...
API en FastAPI que calcula similitud entre jugadores de fútbol (similitud coseno + distancia euclidiana ponderada, con `scikit-learn`), desplegada como función serverless en Vercel. Es el backend de **FM Similitud**, una herramienta para comparar jugadores por estadísticas.

🔗 Deploy: **fm-back-vercel.vercel.app**
